...
{
    class SequenceKeyInspectorView : SequenceItemInspectorView<TimelineModel.SequenceKey>, IUITemplate
    {
        ...
        {
            Model?.SetTransitionSpeed(evt.newValue);
        }
        ...
        protected override void UpdateUI()
        {
            ...
            m_SpeedSlider.SetValueWithoutNotify(Model.TransitionSpeed);
