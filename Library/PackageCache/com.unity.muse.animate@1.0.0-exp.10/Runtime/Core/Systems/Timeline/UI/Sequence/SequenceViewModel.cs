...
namespace Unity.Muse.Animate
{
    class SequenceViewModel
    {
        ...
        public Action<bool> OnEditableChanged;
        ...
        public int TransitionCount => m_TimelineModel.TransitionCount;
        ...
        {
            // Add new keys
            for (var i = SequenceKeyViewModels.Count; i < m_TimelineModel.KeyCount; i++)
            {
            ...
            // Add new transitions
            for (var i = SequenceTransitionViewModels.Count; i < m_TimelineModel.TransitionCount; i++)
            {
            ...
            // Hide extra keys.
            for (var i = m_TimelineModel.KeyCount; i < SequenceKeyViewModels.Count; i++)
            {
            ...
            for (var i = m_TimelineModel.TransitionCount; i < SequenceTransitionViewModels.Count; i++)
            {
        ...
        void MoveKey(TimelineModel.SequenceKey key, int newIndex)
        {
            ...
            m_TimelineModel.MoveKey(oldIndex, newIndex);
        }
