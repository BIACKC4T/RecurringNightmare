...
namespace Unity.Muse.Animate
{
    class EntityControlViewModel: ControlViewModel
    {
        ...
        /// </summary>
        void RingControlDraggingStateChanged()
        {
        ...
        #region Unique User Input Methods
        ...
        #region HandleElementViewModel User Input Methods Overrides
