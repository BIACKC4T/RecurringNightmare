    ...
    class CameraModel
    {
        ...
        public Vector2 Dpi
        {
            get
            {
                ...
                dpi.x = Mathf.Max(dpi.x, RenderScaling.x, Unity.AppUI.Core.Platform.mainScreenScale);
                dpi.y = Mathf.Max(dpi.y, RenderScaling.y, Unity.AppUI.Core.Platform.mainScreenScale);
                return dpi;
            }
        }
