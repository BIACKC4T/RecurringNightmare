...
namespace Unity.Muse.Animate
{
    class PoseAuthoringLogic
    {
        ...
        List<ContextMenu.ActionArgs> m_EntityContextMenuArgs;
        ContextMenu.ActionArgs m_ContextMenuArgsReset = new ContextMenu.ActionArgs()
        {
            KeyIndex = 0,
            DisplayText = "Reset Pose",
            IconName = null,
            IsClickable = true,
            ShortcutText = GetCmd("R")
        };
        ContextMenu.ActionArgs m_ContextMenuArgsCopy = new ContextMenu.ActionArgs()
        {
            KeyIndex = 1,
            DisplayText = "Copy Pose to clipboard",
            IconName = null,
            IsClickable = true,
            ShortcutText = GetCmd("C")
        };
        ContextMenu.ActionArgs m_ContextMenuArgsPaste = new ContextMenu.ActionArgs()
        {
            KeyIndex = 2,
            DisplayText = "Paste Pose from clipboard",
            IconName = null,
            IsClickable = true,
            ShortcutText = GetCmd("V")
        };
        ...
        public PoseAuthoringLogic(AuthoringModel authoringModel, PhysicsSolverComponent physicsSolver, SelectionModel<EntityID> entitySelectionModel, CameraModel cameraModel, VisualElement uiRoot)
        {
            ...
            m_EntityContextMenuArgs = new List<ContextMenu.ActionArgs>()
            {
                m_ContextMenuArgsReset,
                m_ContextMenuArgsCopy,
                m_ContextMenuArgsPaste
            };

            m_EffectorContextMenuArgs = new List<ContextMenu.ActionArgs>
            {
                new ContextMenu.ActionArgs
                {
                    KeyIndex = 0,
                    Action = () => DisableSelectedEffectors(true, true, true),
                    DisplayText = "Disable Effector",
                    IconName = null,
                    IsClickable = true,
                    ShortcutText = "Delete"
                },
                ...
                {
                    KeyIndex = 1,
                    Action = () => DisableSelectedEffectors(true, false, true),
                    DisplayText = "Disable Effector Position",
                    IconName = null,
                    IsClickable = true,
                    ShortcutText = ""
                },
                ...
                {
                    KeyIndex = 2,
                    Action = () => DisableSelectedEffectors(false, true, false),
                    DisplayText = "Disable Effector Rotation",
                    IconName = null,
                    IsClickable = true,
                    ShortcutText = ""
                }
            ...
            JointMask jointMask = null)
        {
            ...
            var entityContextMenuView = EntityUtils.SetupEntityView(viewArmature.gameObject);
            
            entityContextMenuView.OnRightClick += clickPosition =>
            {
                m_EntityContextMenuArgs[2].IsClickable = canPastePose();
                m_CameraModel.OpenContextMenu(m_uiRoot, clickPosition, m_EntityContextMenuArgs);
            };
            ...
            m_ContextMenuArgsReset.Action = resetPose;
            m_ContextMenuArgsCopy.Action = copyPose;
            m_ContextMenuArgsPaste.Action = pastePose;
        }
        ...
        private void DisableSelectedEffectors(bool disablePosition, bool disableRotation, bool disableLookAt)
        {
