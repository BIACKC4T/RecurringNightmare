...
namespace Unity.DeepPose.Cloud
{
    static class RequestUtils
    {
        ...
        public static void SendRequestResponseRaw(string apiUrl, object data, Action<byte[]> onSuccess, Action<string> onFail, List<KeyValuePair<string, string>> headers = null)
        {
            var request = CreateRequest(apiUrl, data, headers);
            request.certificateHandler = new AcceptAllCertificates();
        ...
        static UnityWebRequest CreateRequest(string apiUrl, object data, List<KeyValuePair<string, string>> headers = null, string method = "post")
        {
