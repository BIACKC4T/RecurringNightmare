...
namespace Unity.DeepPose.Core
{
    ...
    {
        public TensorFloat FrameTimes;
        public TensorFloat InputPositions;
        public TensorFloat InputPositionsTolerance;
        public TensorFloat InputPositionsMask;
        public TensorFloat InputRotations;
        public TensorFloat InputRotationsTolerance;
        public TensorFloat InputRotationsMask;
        ...
        public void Evaluate(IModelBackend backend)
        {
            ...
            var predictedContacts = m_HasContacts ? backend.PeekOutput("contact_predictions") as TensorFloat : null;
