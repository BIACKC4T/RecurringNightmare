...
namespace Unity.DeepPose.Core
{
    struct AutoregressiveSolverData : IDisposable
    {
        ...
        TensorFloat m_InputTolerance;

        TensorInt m_AllocatedInputFrameIndices;
        TensorFloat m_AllocatedInputPositions;
        TensorFloat m_AllocatedInputRotations;
        TensorFloat m_AllocatedInputRaycasts;
